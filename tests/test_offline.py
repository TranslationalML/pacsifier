...
#     if os.path.isdir("/tests/tmp/dicomdir"):
#         shutil.rmtree("/tests/tmp/dicomdir")

#     os.mkdir("/tests/tmp/dicomdir")
#     move_and_rename_files("/tests/test_set", "/tests/tmp/dicomdir")
#     assert len(glob("/tests/test_set/*/*")) == len(glob("/tests/tmp/dicomdir/*/*"))
#     assert len(glob("/tests/test_set/*")) == len(glob("/tests/tmp/dicomdir/*"))
#     # print()
#     assert len(glob("/tests/test_set/*/*/*/*")) == len(glob("/tests/tmp/dicomdir/*/*/*/*"))
#     create_dicomdir("/tests/tmp/dicomdir")
#     # os.chdir(os.path.abspath("./src/tests/"))
#     # assert os.path.join(".", "dicomdir", "DICOMDIR") in glob(
#     #     os.path.join(".", "dicomdir", "*")
#     # )
...
#     os.mkdir("/tests/tmp/dicomdir")
#     n_csv_files = sorted(glob("/tests/test_set/sub-*/ses-*/*.csv"))
#     n_csv_files = [csv.split(os.sep)[-1] for csv in n_csv_files]

#     move_dumps.move("/tests/test_set", "/tests/tmp/dicomdir")

#     assert glob("/tests/test_set/sub-*/ses-*/*.csv") == []
#     assert [
#         csv.split(os.sep)[-1] for csv in sorted(glob("/tests/tmp/dicomdir/sub-*/ses-*/*.csv"))
#     ] == n_csv_files

#     move_dumps.move("/tests/tmp/dicomdir", "/tests/test_set")

#     assert [
#         csv.split(os.sep)[-1] for csv in sorted(glob("/tests/test_set/sub-*/ses-*/*.csv"))
#     ] == n_csv_files
#     assert glob("/tests/tmp/dicomdir/sub-*/ses-*/*.csv") == []
...
# 	convert_to_nifti("XXXX", "YYYY", "/tests/test_set")
# 	convert_to_nifti("XXXX", "YYYY", "/tests/test_set")
# 	convert_all("/tests/test_set")
# 	if os.path.isdir("/tests/test_set/Nifti"):
# 		shutil.rmtree("/tests/test_set/Nifti")
# 	shutil.rmtree("/tests/test_set/sub-XXXX")
