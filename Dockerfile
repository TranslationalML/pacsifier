...
RUN conda update conda && conda config --add channels conda-forge
COPY ./deployment/utils/environment_minimal.yml .
RUN conda env create -f environment_minimal.yml
